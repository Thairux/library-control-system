...
<head>
    ...
    <title>Home &middot Library Control System</title>
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-start">
                        <h1>Check the Library Status</h1>
                        <p>You can now check the Library's status remotely in real time</p>
                        <p><a class="btn btn-lg btn-primary" href="#">Check Status</a></p>
                    </div>
                </div>
            </div>
